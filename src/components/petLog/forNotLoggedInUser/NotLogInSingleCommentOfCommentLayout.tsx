...
import { seePetLogCommentOfComments_seePetLogCommentOfComments_commentOfComments } from "../../../__generated__/seePetLogCommentOfComments";
...
const NotLogInSingleCommentOfCommentLayout = ({mention}:{mention:seePetLogCommentOfComments_seePetLogCommentOfComments_commentOfComments}) => {
