...
type VideoWithScreenTouchNotFeedType = {
...
const VideoWithScreenTouchNotFeed = ({uri,index,onScreenIndex}:VideoWithScreenTouchNotFeedType) => {

  const [paused,setPaused] = useState(true);

  useEffect(()=>{
    setPaused(onScreenIndex !== index);
  },[onScreenIndex])
...
export default VideoWithScreenTouchNotFeed;