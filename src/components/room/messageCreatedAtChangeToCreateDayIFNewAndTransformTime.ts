...
import { getRoomMessages_getRoomMessages } from "../../__generated__/getRoomMessages";
import getCreatedTimeAndDayByTimestamp from "./logic/getCreatedTimeAndDayByTimestamp";

type tType = (messages:getRoomMessages_getRoomMessages[]) => transformedMessages 
...
const messageCreatedAtChangeToCreateDayIFNewAndTransformTime:tType = (messages:getRoomMessages_getRoomMessages[]) => {
